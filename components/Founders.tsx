  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-32 w-96 h-96 rounded-full blur-3xl bg-purple-600/10" />
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 rounded-full blur-3xl bg-violet-600/10" />
      </div>

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium mb-6 bg-white/5 text-white/70 border border-purple-500/20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {founders.map((founder, index) => (
            <div
              ...
              className="group relative rounded-3xl overflow-hidden bg-white/[0.02] border border-purple-500/10 hover:border-purple-500/30 transition-all duration-500"
            >
              ...
              <div className="absolute inset-[1px] rounded-3xl bg-[#080808] z-0" />
              ...
              <div className="relative z-10 p-6 sm:p-8">
                <div className="flex flex-col sm:flex-row gap-6 sm:gap-8 items-center sm:items-start">
                  ...
                  <div className="relative flex-shrink-0">
                    ...
                    {/* Floating badge */}
                    <div className="absolute -bottom-3 -right-3 px-3 py-1.5 rounded-full text-xs font-bold bg-purple-500 text-white shadow-lg shadow-purple-500/25">
                      Available
                    </div>
                  </div>
                  ...
                  <div className="flex-1 text-center sm:text-left">
                    ...
                    <p className="text-sm sm:text-base leading-relaxed mb-6 text-gray-400">
                      {founder.bio}
                    </p>
                    ...
                    <div className="flex items-center justify-center sm:justify-start gap-3">
                      {founder.socials.linkedin && (
                        <a
                          ...
                          className="group/icon w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-300 bg-white/5 hover:bg-purple-500/20 text-gray-400 hover:text-purple-400"
                        >
                      ...
                      {/* Connect Button */}
                      <button className={`ml-2 px-4 py-2 rounded-xl text-sm font-medium transition-all duration-300 bg-gradient-to-r ${founder.gradient} text-white hover:shadow-lg hover:shadow-purple-500/25 hover:scale-105`}>
                        Connect
                      </button>
                    </div>
                  </div>
        ...
        <div className="mt-16 text-center">
          ...
          <a
            href="#careers"
            className="inline-flex items-center gap-2 text-sm font-medium transition-all duration-300 hover:gap-3 text-purple-400 hover:text-purple-300"
          >
            View Open Positions
